...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.label_input1=customtkinter.CTkLabel(self.input_frame,text="INPUT:",corner_radius=8,font=('Times New Roman',17,'bold'))
        self.input_text=customtkinter.CTkTextbox(self.input_frame,width=400,height=400,font=('Times New Roman',17,'bold'))
        self.label_input2=customtkinter.CTkLabel(self.input_frame,text="INPUT STRING:",corner_radius=8,font=('Times New Roman',17,'bold'))
        self.input_string=customtkinter.CTkTextbox(self.input_frame,width=400,height=100,font=('Times New Roman',17,'bold'))
        ...
        self.output_text=customtkinter.CTkTextbox(self.output_frame,width=400,height=525,font=('Times New Roman',17,'bold'))
    ...
    def rundfavalidator(self):
        ...
        text_file.close()
        exec(open(os.path.abspath('Validators/dfa.py')).read())
        self.output_text.configure(state="disabled")
